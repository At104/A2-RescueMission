...
import ca.mcmaster.se2aa4.island.team104.algorithm.states.EndingState;
...
public class NewSearchState extends State {
    private static final Logger log = LogManager.getLogger(NewSearchState.class);
    private Action action;
    private boolean changingDirection;
    private boolean leftLandFound = false;
    private boolean vertLandFound = false;

    public NewSearchState(Drone drone) {
        super(drone);
    ...
    public State getNextState(ActionResult result) {
        ...
        log.info("Vertical land found: {}", vertLandFound);
